...
riscv32-unknown-elf-ld -b elf32-littleriscv start.o ${NAME}.o -T link.ld -Map=${NAME}.map -o ${NAME}  --no-warn-rwx-segments --no-relax /opt/riscv32i/riscv32-unknown-elf/lib/libm_nano.a /opt/riscv32i/riscv32-unknown-elf/lib/libc_nano.a /opt/riscv32i/riscv32-unknown-elf/lib/libg_nano.a /opt/riscv32i/lib/gcc/riscv32-unknown-elf/14.2.0/libgcc.a -u _printf_float --gc-sections
